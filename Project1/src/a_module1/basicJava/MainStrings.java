...
//		escape sequence
//		backslash in a String this tells Java to "escape" or 
//		skip the next character's function and simply add it to the String

		System.out.println("He said \"Hi");
		System.out.println("He said \"Hi\"");
		System.out.println("John \"JJ\" Doe");
//		System.out.println("Use \, not /"); // Use \, not /
		System.out.println("Use , not /");
		System.out.println("To escape special strings, Use \\, not /");

		System.out.println("1\titem"); // \t put a tab
		System.out.println("fistname\tlastname"); // \t put a tab
		System.out.println("Ahmet\t\tSen"); // \t put a tab
...
//		out refers to the standard "out"put device: the "console"
...
//		System.out.println("!");
//		System.out.print("!");
		System.out.print("!\n"); // println() is just print() but with a newLine
...
//		  Which of the following are valid Strings? 
//				  "hello world" 
//				  "h3110_w0r1d"
//				  "hello World" 
//				  ""hello" "world"" // Why not? Double quotes need to be escaped with backslashes
//		 "hello world"
